        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <nav class="mb-8" aria-label="Breadcrumb">
                <ol class="flex items-center space-x-2 text-sm text-gray-500">
                    ...
                    <li class="text-gray-900 font-medium" aria-current="page">Pengajuan SKTM</li>
                </ol>
            </nav>
            ...
            <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
                <div class="p-8 border-b border-gray-100">
                    <h1 class="text-2xl font-bold text-gray-900">Form Pengajuan Surat Keterangan Tidak Mampu (SKTM)</h1>
                    <p class="mt-2 text-gray-600">Lengkapi data di bawah ini dengan benar untuk permohonan SKTM Anda.</p>
                </div>

                <div class="p-8">
                    <form action="{{ route('form.sktm.post') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <textarea id="alamat" name="alamat" rows="3"
                                    ...
                                    placeholder="Alamat sesuai KTP" required>{{ old('alamat', $penduduk->alamat ?? '') }}</textarea>
                                @error('alamat')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <!-- Keperluan -->
                            <div class="col-span-1 md:col-span-2">
                                <label for="keperluan" class="block text-sm font-semibold text-gray-700 mb-2">Keperluan SKTM</label>
                                <input type="text" id="keperluan" name="keperluan" value="{{ old('keperluan') }}"
                                    ...
                                    placeholder="Contoh: Beasiswa Pendidikan / Keringanan Biaya RS" required>
                                @error('keperluan')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <textarea id="keterangan" name="keterangan" rows="2"
                                    ...
                                    placeholder="Informasi tambahan jika diperlukan" required>{{ old('keterangan') }}</textarea>
                                @error('keterangan')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
            ...
            <div class="mt-8 p-4 bg-blue-50 border border-blue-100 rounded-lg flex items-start space-x-3">
                ...
                <div class="text-sm text-blue-800">
                    ...
                    <p>SKTM diterbitkan bagi warga yang benar-benar membutuhkan. Penyalahgunaan data dapat dikenakan sanksi sesuai ketentuan yang berlaku.</p>
                </div>
            </div>
        </div>
    </div>
