<div class="bg-gradient-to-r from-blue-50 to-indigo-50 py-12 font-[sans-serif] rounded-xl shadow-md">
    <div class="max-w-6xl mx-auto px-4">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-md:max-w-md mx-auto">
        <div class="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all transform hover:-translate-y-2 duration-300 border border-blue-50">
          <div class="p-8 relative overflow-hidden">
            <div class="absolute -right-10 -top-10 bg-blue-50 w-24 h-24 rounded-full opacity-80"></div>
            <svg xmlns="http://www.w3.org/2000/svg" fill="#007bff" class="w-10 h-10 mb-6 relative z-10" viewBox="0 0 32 32">
            ...
            <h3 class="text-gray-800 text-xl font-bold mb-3">Kostumisasi</h3>
            <p class="text-gray-600 text-sm leading-relaxed">Sesuaikan layanan sesuai kebutuhan Anda mulai dari permohonan surat hingga laporan warga, semuanya bisa dipersonalisasi.</p>
            <div class="mt-6">
        ...
        <div class="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all transform hover:-translate-y-2 duration-300 border border-blue-50">
          <div class="p-8 relative overflow-hidden">
            <div class="absolute -right-10 -top-10 bg-blue-50 w-24 h-24 rounded-full opacity-80"></div>
            <svg xmlns="http://www.w3.org/2000/svg" fill="#007bff" class="w-10 h-10 mb-6 relative z-10" viewBox="0 0 682.667 682.667">
              <defs>
            ...
            <h3 class="text-gray-800 text-xl font-bold mb-3">Keamanan</h3>
            <p class="text-gray-600 text-sm leading-relaxed">Data pribadi Anda dilindungi dengan sistem keamanan terkini untuk privasi dan kepercayaan maksimal.</p>
            <div class="mt-6">
              <a href="#" class="text-blue-600 hover:text-blue-800 text-sm font-medium inline-flex items-center">
                Pelajari lebih lanjut
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all transform hover:-translate-y-2 duration-300 border border-blue-50">
          <div class="p-8 relative overflow-hidden">
            <div class="absolute -right-10 -top-10 bg-blue-50 w-24 h-24 rounded-full opacity-80"></div>
            <svg xmlns="http://www.w3.org/2000/svg" fill="#007bff" class="w-10 h-10 mb-6 relative z-10" viewBox="0 0 24 24">
            ...
            <h3 class="text-gray-800 text-xl font-bold mb-3">Performa</h3>
            <p class="text-gray-600 text-sm leading-relaxed">Nikmati proses layanan yang cepat, efisien, dan tanpa hambatan.</p>
            <div class="mt-6">
              <a href="#" class="text-blue-600 hover:text-blue-800 text-sm font-medium inline-flex items-center">
                Pelajari lebih lanjut
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
