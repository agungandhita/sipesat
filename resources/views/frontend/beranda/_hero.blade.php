      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-md:max-w-md mx-auto">
        <div class="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all">
          <div class="p-8">
            ...
            <h3 class="text-gray-800 text-xl font-semibold mb-3">Kostumisasi</h3>
            <p class="text-gray-500 text-sm leading-relaxed">Sesuaikan layanan sesuai kebutuhan Anda mulai dari permohonan surat hingga laporan warga, semuanya bisa dipersonalisasi.</p>
          </div>
        </div>
        ...
        <div class="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all">
          <div class="p-8">
            ...
            <h3 class="text-gray-800 text-xl font-semibold mb-3">Kemanan</h3>
            <p class="text-gray-500 text-sm leading-relaxed">Data pribadi Anda dilindungi dengan sistem keamanan terkini untuk privasi dan kepercayaan maksimal</p>
          </div>
        </div>
        ...
        <div class="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all">
          <div class="p-8">
            ...
            <h3 class="text-gray-800 text-xl font-semibold mb-3">Performa</h3>
            <p class="text-gray-500 text-sm leading-relaxed">Nikmati proses layanan yang cepat, efisien, dan tanpa hambatan</p>
          </div>
        </div>
      </div>
    </div>
