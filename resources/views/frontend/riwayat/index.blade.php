                            ...
                            <table class="w-full text-left divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th class="px-3 sm:px-6 py-3 text-xs font-medium text-gray-500 uppercase">Jenis Surat</th>
                                        <th class="hidden sm:table-cell px-3 sm:px-6 py-3 text-xs font-medium text-gray-500 uppercase">Tanggal</th>
                                        <th class="px-3 sm:px-6 py-3 text-xs font-medium text-gray-500 uppercase">Status</th>
                                        <th class="px-3 sm:px-6 py-3 text-xs font-medium text-gray-500 uppercase">Catatan Admin</th>
                                        <th class="px-3 sm:px-6 py-3 text-xs font-medium text-gray-500 uppercase text-right">Aksi</th>
                                    </tr>
                                </thead>
                                <tbody class="divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-3 sm:px-6 py-3">{{ ucfirst($p->jenis_surat) }}</td>
                                        <td class="hidden sm:table-cell px-3 sm:px-6 py-3">{{ $p->created_at->format('d/m/Y') }}</td>
                                        ...
                                        <td class="px-3 sm:px-6 py-3">
                                            <div class="flex justify-end gap-2">
                                                <button type="button" 
                                                    onclick="showDetail('{{ $p->pengajuan_id }}')"
        ...
        function showDetail(id) {
            ...
            fetch(`/pengajuan/${id}/detail`)
                ...
                .catch(error => {
                    ...
                    document.getElementById('modalContent').innerHTML = '<p class="text-red-500">Terjadi kesalahan saat memuat data</p>';
                });
        }
