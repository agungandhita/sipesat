<div class="grid lg:grid-cols-3 sm:grid-cols-2 gap-10 mt-14">
    <div>
        <svg xmlns="http://www.w3.org/2000/svg" class="w-8 fill-yellow-400 mb-4 inline-block" viewBox="0 0 32 32">
            <path
        ...
        <p>Nikmati menu yang dirancang sesuai dengan selera Anda. Kami menyediakan pilihan hidangan yang bisa
            disesuaikan dengan preferensi Anda, baik untuk vegetarian, vegan, maupun diet khusus lainnya.</p>
        <a href="javascript:void(0);" class="text-blue-600 font-semibold inline-block mt-2 hover:underline">Pelajari lebih
            Lanjut
        </a>
    </div>
    <div>
        <svg xmlns="http://www.w3.org/2000/svg" class="w-8 fill-yellow-400 mb-4 inline-block"
            ...
            <g fill="none" class="stroke-yellow-400" stroke-linecap="round" stroke-linejoin="round"
        ...
        <p>Keamanan Anda adalah prioritas kami. Kami memastikan setiap pesanan dan pembayaran dilakukan dengan standar
            keamanan tertinggi agar Anda merasa aman dan nyaman.</p>
        <a href="javascript:void(0);" class="text-blue-600 font-semibold inline-block mt-2 hover:underline">Pelajari
            lebih lanjut</a>
    </div>
    <div>
        <svg xmlns="http://www.w3.org/2000/svg" class="w-8 fill-yellow-400 mb-4 inline-block"
        ...
        <p>Butuh bantuan? Layanan pelanggan kami siap 24/7 untuk membantu Anda, mulai dari reservasi hingga permintaan
            khusus. Kami selalu ada untuk Anda.</p>
        <a href="javascript:void(0);" class="text-blue-600 font-semibold inline-block mt-2 hover:underline">Pelajari
            lebih lanjut</a>
    </div>
    <div>
        <svg xmlns="http://www.w3.org/2000/svg" class="w-8 fill-yellow-400 mb-4 inline-block" viewBox="0 0 24 24">
        ...
        <p>Rasakan layanan cepat dan berkualitas dari kami. Kami memastikan pesanan Anda disiapkan dan disajikan dengan
            cepat tanpa mengurangi kualitas rasa..</p>
        <a href="javascript:void(0);" class="text-blue-600 font-semibold inline-block mt-2 hover:underline">Pelajari
            lebih lanjut</a>
    </div>
    <div>
        <svg xmlns="http://www.w3.org/2000/svg" class="w-8 fill-yellow-400 mb-4 inline-block" viewBox="0 0 504.69 504.69">
            <path
        ...
        <p>Nikmati pengalaman kuliner yang melampaui batas dengan cita rasa internasional. Kami menghadirkan hidangan
            dari berbagai negara yang siap memanjakan lidah Anda.</p>
        <a href="javascript:void(0);" class="text-blue-600 font-semibold inline-block mt-2 hover:underline">Pelajari
            lebih lanjut</a>
    </div>
    <div>
        <svg xmlns="http://www.w3.org/2000/svg" class="w-8 fill-yellow-400 mb-4 inline-block"
            ...
            <g fill="none" class="stroke-yellow-400" stroke-miterlimit="10" stroke-width="30" clip-path="url(#a)"
                transform="matrix(1.33 0 0 -1.33 0 682.667)">
                <path
        ...
        <p>Hubungi kami dengan mudah untuk reservasi atau pertanyaan. Tim kami siap memberikan informasi yang Anda
            butuhkan dengan respon yang cepat.</p>
        <a href="javascript:void(0);" class="text-blue-600 font-semibold inline-block mt-2 hover:underline">Pelajari
            lebih lanjut</a>
    </div>
