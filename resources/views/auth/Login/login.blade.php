    ...
    <div class="min-h-screen flex flex-col items-center justify-center py-6">
      <div class="max-w-md w-full">
        <div class="md:flex"><img
          src="{{ asset('img/lamongan.png') }}" alt="logo" class='w-23 mx-auto block' />
        ...
        <div class="p-8 rounded-2xl bg-white shadow">
          ...
          <form class="mt-8 space-y-4" action="{{ route('login') }}" method="POST">
            ...
            <p class="text-gray-800 text-sm !mt-8 text-center">Belum punya akun? <a href="{{ route('register') }}" class="text-blue-600 hover:underline ml-1 whitespace-nowrap font-semibold">Daftar disini</a></p>
          </form>
        </div>
      </div>
    </div>
