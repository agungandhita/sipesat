...
<div class="font-[sans-serif] bg-gray-100 max-w-4xl flex items-center mx-auto md:h-screen p-4">
    <div class="grid md:grid-cols-3 shadow-2xl bg-white items-center rounded-xl overflow-hidden">
      ...
      <form class="md:col-span-2 w-full py-6 px-6 sm:px-16" action="/register/akun" method="POST" >
        @csrf
        <div class="mb-6">
        ...
        <div class="space-y-6">
          <div>
            ...
            <div class="relative flex items-center">
              <input name="nama" type="text" required class="text-gray-800 bg-white border border-gray-300 w-full text-sm px-4 py-2.5 rounded-md outline-blue-500 @error('nama') border-red-500 @enderror" placeholder="Masukkan Nama" value="{{ old('nama') }}" />
          ...
          <div>
            ...
            <div class="relative flex items-center">
                <input name="email" type="email" required class="text-gray-800 bg-white border border-gray-300 w-full text-sm px-4 py-2.5 rounded-md outline-blue-500 @error('email') border-red-500 @enderror" placeholder="Masukkan Email" value="{{ old('email') }}" />
          ...
          <div>
            ...
            <div class="relative flex items-center">
              <input name="password" type="password" required class="text-gray-800 bg-white border border-gray-300 w-full text-sm px-4 py-2.5 rounded-md outline-blue-500 @error('password') border-red-500 @enderror" placeholder="Enter password" />
