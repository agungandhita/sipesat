...
@section('container')
    <div class="pt-24 px-4 sm:px-6 lg:px-8">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @if ($data->count() > 0)
                                @foreach ($data as $no => $item)
                                    ...
                                    <!-- Edit Modal -->
                                    <div id="hs-scale-animation-modal{{ $no }}" class="hs-overlay hidden w-full h-full fixed top-0 left-0 z-[60] overflow-x-hidden overflow-y-auto bg-black bg-opacity-50 backdrop-blur-sm">
                                        <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto">
                                            <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]">
                                                <div class="flex justify-between items-center py-3 px-4 border-b dark:border-gray-700">
                                                    ...
                                                    <button type="button" class="hs-dropdown-toggle inline-flex flex-shrink-0 justify-center items-center h-8 w-8 rounded-md text-gray-500 hover:text-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-white focus:ring-offset-white focus:ring-blue-600 transition-all text-sm dark:bg-slate-900 dark:hover:bg-slate-800 dark:border-gray-700 dark:text-gray-400 dark:hover:text-white dark:focus:ring-offset-gray-800" data-hs-overlay="#hs-scale-animation-modal{{ $no }}">
                                                ...
                                                <div class="p-4 overflow-y-auto">
                                                    <form action="{{ route('penduduk.update', $item->warga_id) }}" method="POST" class="space-y-4" id="editForm{{ $no }}">
                                                        @csrf
                                                        <div class="grid gap-4">
                                                            <div>
                                                                <label for="nama{{ $no }}" class="block text-sm font-medium mb-2 dark:text-white">Nama</label>
                                                                <input type="text" id="nama{{ $no }}" name="nama" class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" value="{{ $item->nama }}" required>
                                                            </div>
                                                            <div>
                                                                <label for="nik{{ $no }}" class="block text-sm font-medium mb-2 dark:text-white">NIK</label>
                                                                <input type="text" id="nik{{ $no }}" name="nik" class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" value="{{ $item->nik }}" required pattern="[0-9]{16}" title="NIK harus 16 digit angka">
                                                            </div>
                                                            <div>
                                                                <label for="jenis_kelamin{{ $no }}" class="block text-sm font-medium mb-2 dark:text-white">Jenis Kelamin</label>
                                                                <select id="jenis_kelamin{{ $no }}" name="jenis_kelamin" class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" required>
                                                            ...
                                                            <div>
                                                                <label for="alamat{{ $no }}" class="block text-sm font-medium mb-2 dark:text-white">Alamat</label>
                                                                <textarea id="alamat{{ $no }}" name="alamat" class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" required>{{ $item->alamat }}</textarea>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="relative w-full max-w-md max-h-full">
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <div class="p-6 text-center">
                                                    ...
                                                    <form action="{{ route('penduduk.hapus', $item->warga_id) }}"
                                                        method="POST">
                                                        @csrf
        ...
        <!-- Create Penduduk Modal -->
        <div id="create-penduduk-modal"
                ...
                <div
                    ...
                    <div class="flex justify-between items-center py-3 px-4 border-b dark:border-gray-700">
                        ...
                        <button type="button"
                            ...
                            data-hs-overlay="#create-penduduk-modal">
                            ...
                            <div class="grid gap-y-4">
                                ...
                                <div>
                                    <label for="jenis_kelamin"
                                        class="block text-sm font-medium mb-2 dark:text-white">Jenis Kelamin</label>
