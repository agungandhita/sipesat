...
@section('container')
    <div class="pt-24 px-4 sm:px-6 lg:px-8">
        ...
        {{-- <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 mt-6">
            ...
            <div
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-800">{{ $data->count() > 0 ? rand(0, $data->count()) : 0 }}
                        </p>
                    </div>
                </div>
                <div
                                    ...
                                    <div class="relative w-full max-w-md max-h-full">
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-6 text-center">
                                                ...
                                                <button data-modal-hide="popup-modal{{ $no }}" type="button"
